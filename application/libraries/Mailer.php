...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'kprasetya029@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Admin Siakad'; // Isikan dengan nama pengirim
    protected $password = 'wlpwbwytgltrwqmh'; // Isikan dengan password email pengirim
    ...
    public function send_with_attachment($data){
        ...
        $mail->Subject = $data['subjek'];
        $mail->Body = $data['content'];
        $mail->AddEmbeddedImage('assets/img/images_email/logo.jpg', 'logo_stmik_akakom', 'logo.jpg'); // Aktifkan jika ingin menampilkan gambar dalam email
